...
public class DeviceService implements IDeviceService {
    ...
    @Override
    public DeviceDto update(long id, final DeviceRequestDto deviceRequestDto) {
        Device existingDevice = this.deviceRepository.findById(id)
                .orElseThrow(() -> ServiceErrorCatalog
    ...
    public void delete(final long id) {
        Device deviceToDelete = this.deviceRepository.findById(id)
                .orElseThrow(() -> ServiceErrorCatalog
