...
import com.example.mqttclient.service.utilities.MqttSubscriptionManager;
...
public class MqttClientService {
    ...
    public synchronized void updateSubscription(final DeviceMeasurementDto measure) {
        final com.antonigari.grpcclient.model.DeviceMeasurementDto existingMeasure =
    ...
    private void unsubscribeTopic(final com.antonigari.grpcclient.model.DeviceMeasurementDto measure) {
        try {
